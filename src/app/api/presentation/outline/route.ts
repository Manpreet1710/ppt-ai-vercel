...
Format the response starting with the title as a markdown heading, followed by markdown content with each topic as a heading and 2-3 bullet points.

Example format:
# Your Generated Presentation Title Here
...
export async function POST(req: Request) {
  try {
    ...
    // Force Gemini model, ignoring any provider sent from the client
