...
## VISUALS GUIDELINES
- Create a specific, detailed, and relevant image query for every slide.
- The query must be directly related to the slide's content and be at least 10 words long.
- Example: Instead of "data", use "abstract visualization of complex data networks with glowing nodes".
- Use the <IMG query="..." /> tag for all image queries.
